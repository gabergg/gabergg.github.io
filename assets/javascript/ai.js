...
AI.prototype.decideMove = function () {
...
AI.prototype.tryMove = function (location) {
    if ($('#' + location).html() == '') {
        $('#' + location).html('O');
...
AI.prototype.checkWin = function (player) {
...
AI.prototype.checkPotentialFork = function () {
...
AI.prototype.check = function (cornerOrSide) {
    var foundSpace = false;
...
AI.prototype.diagonalForkSetup = function () {
